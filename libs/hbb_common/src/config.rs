...
lazy_static::lazy_static! {
    ...
    pub static ref PROD_RENDEZVOUS_SERVER: RwLock<String> = RwLock::new("161.104.18.157".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["161.104.18.157"];
pub const RS_PUB_KEY: &str = "Ll9KARICdpsjFXVGKLLW9bw09NdLFUpUcBQpc+tpb6w=";
